...
find /clang0-tools/{,${HEIWA_TARGET}/}lib{,64}/ -maxdepth 1 -type f \
-exec ${HEIWA_TARGET}-strip --strip-debug {} \;

find /clang0-tools/libexec/gcc/${HEIWA_TARGET}/*/ -type f \
-exec ${HEIWA_TARGET}-strip --strip-unneeded {} \;

find /clang0-tools/{,${HEIWA_TARGET}/}bin/ -maxdepth 1 -type f \

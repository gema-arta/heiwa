...
> #### Announcement
> * Currently only focus on **x86_64** architecture, build with native CPU optimization and ThinLTO for pure Clang/LLVM toolchain. [Triplet @ OSdev](https://wiki.osdev.org/Target_Triplet).

...
> #### Announcement
> * Currently only focus on **x86_64** arch, build with native CPU optimization and ThinLTO for final Clang/LLVM toolchain. [Triplet @ OSdev](https://wiki.osdev.org/Target_Triplet).

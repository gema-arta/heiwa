...
> #### Announcement
> * Currently only focus on **x86_64** architecture, build with native CPU optimization and ThinLTO for the final toolchain. [See triplet at OSDev](https://wiki.osdev.org/Target_Triplet).
